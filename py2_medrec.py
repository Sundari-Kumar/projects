...
def recommend_medicine():
    ...
    # Predefined symptoms and medicine recommendations
    medicines = {
        "fever": "Take Paracetamol or Ibuprofen.",
        "headache": "Take Aspirin or Ibuprofen.",
        "cold": "Take Antihistamines or Decongestants.",
        "cough": "Take Cough Syrup or Lozenges.",
        "stomach ache": "Take Antacids or Pepto-Bismol.",
        "fatigue": "Try taking Vitamin B12 supplements or rest."
    }

    # Find medicine based on symptoms
    recommendation = "Sorry, I don't have a recommendation for that symptom."
    for symptom, medicine in medicines.items():
        if symptom in symptoms:
            recommendation = "For {}, you can: {}".format(symptom, medicine)
            break

    # Display the user's message and recommendation in the chat history
    chat_history.config(state=tk.NORMAL)
    chat_history.insert(tk.END, "You: " + user_input + "\n")
    chat_history.insert(tk.END, "Bot: " + recommendation + "\n\n")
...
# GUI setup
app = tk.Tk()
app.title("Register, Login, and Medicine Recommendation System")
...
send_button = tk.Button(chatbot_frame, text="Send", command=recommend_medicine)
